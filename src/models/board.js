  ...
  buildLevel(blueprint) {
    this.tiles = blueprint.map((row, rIdx) => {
      return row.map((tile, tIdx) => {
        ...
        } else if (shopTowerTypes.includes(tile)) {
          // should place tower without applying gold since this is generated by
          // level blueprints
          const towerLoc = new Tile({loc, game: this.game})
          towerLoc.adminPlaceTower(tile);
          return towerLoc;
        } else {
